...
7. Right click on the Automation Toolbox project, click Build Path, Add External Archives, add all of the files that you extraced from External Jar Files.zip
